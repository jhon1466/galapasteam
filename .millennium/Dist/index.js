...
let PluginEntryPointMain = function () {
    var millennium_main = function (e) { "use strict"; return function () { const e = {}; try { if (process) return process.env = Object.assign({}, process.env), void Object.assign(process.env, e) } catch (e) { } globalThis.process = { env: e } }(), e.default = async function () { }, Object.defineProperty(e, "__esModule", { value: !0 }), e }({});
